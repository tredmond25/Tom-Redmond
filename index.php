...
<html lang="en">
    ...
    <body>
        <header>
            <h1>Human Powered Business Model</h1>
            <h2>Why businesses should put stakeholders before shareholders</h2>
        </header>
        <nav>
        ...
        <main>
            ...
            <section>
                <h2>Why human powered business model should be adopted</h2>
                <ul>
                    <li>Helps fight economic/wage inequality</li>
            ...
            <section>
                ...
                <table>
                    <caption><strong>Key principles</strong></caption>
                    <tr>
                    ...
                    <tr>
                        <td>Deep respect for others</td>
                        <td>Real work-life balance</td>
                        <td>Payed well</td>
                    </tr>
                    <tr>
                        <td>Personal Growth</td>
                        <td>Spending time with family/friends</td>
                        <td>Good benefits</td>
                    </tr>
                    <tr>
                        <td>Career Growth</td>
                        <td>Vacation time</td>
                        <td>Appropriate raises/bonuses</td>
                    </tr>
                    <tr>
